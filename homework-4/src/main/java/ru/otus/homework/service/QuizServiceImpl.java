...
public class QuizServiceImpl implements QuizService {
    ...
    public void startQuiz(String userName) {
        ...
        studentGreeting(questionService.getCountQuestions(), userName);
    ...
    private void studentGreeting(int questionsCount, String studentName) {
    ...
    private void endQuiz(int answersForPassing, int correctAnswers) {
        messageService.showMessage("strings.quizCompleted",
                String.format("%s%n%s%n", correctAnswers,
