...
public class GenreControllerTest {
    ...
    private final static long GENRE_ID = 100;
    ...
    @ValueSource(strings = { "/genres", "/addGenre", "/editGenre?id=" + GENRE_ID })
    ...
    @ValueSource(strings = { "/genres", "/addGenre", "/editGenre?id=" + GENRE_ID, "/deleteGenre?id=" + GENRE_ID })
    ...
    @ParameterizedTest(name = "{index}: GET {0} вернет 302 на /login для неаутентифицированного пользователя")
    @ValueSource(strings = { "/addGenre", "/editGenre", "/deleteGenre" })
    ...
    @ValueSource(strings = { "/addGenre", "/editGenre", "/deleteGenre?id=" + GENRE_ID })
    ...
    @ValueSource(strings = { "/addGenre", "/editGenre?id=" + GENRE_ID, "/deleteGenre?id=" + GENRE_ID })
